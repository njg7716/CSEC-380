...
if($has_session){
	...
	if (!isset($_SESSION['login']) or !isset($_SESSION['user_id'])){
		...
		session_destroy();
		die("<script nonce='Yeet'>window.location.href = '/index.php';</script>Invalid Session");
	}
...
<link nonce="Yeet" href="//cdnjs.cloudflare.com/ajax/libs/x-editable/1.5.0/jqueryui-editable/css/jqueryui-editable.css" rel="stylesheet"/>
<script nonce="Yeet" src="//cdnjs.cloudflare.com/ajax/libs/x-editable/1.5.0/jqueryui-editable/js/jqueryui-editable.min.js"></script>
	<script nonce="Yeet">
